    ...
    >
      ...
      >
        <div>
          ...
          <Typography variant="h4" color="text.blackvariant" sx={{ py: 1 }}>Here is the analysis of your writing performance so far. Overall you are doing great.</Typography>
        </div>
        <DropDown />
      </Box>
      <Container
